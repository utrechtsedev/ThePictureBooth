  ...
  async function loadCustomers() {
    ...
    customers = [
      ...
      },
      {
        ...
        notes:
          "Mogelijkheid tot vaste samenwerking voor maandelijkse themafeesten",
  ...
  function applyFilters() {
    ...
    if (selectedFilter === "individual") {
      ...
      results = results.filter(
        (customer) => customer.events && customer.events.length > 0,
      );
    ...
    >
      <div class="flex justify-between items-start">
        <div>
          ...
          <p
            class="text-sm text-green-600 dark:text-green-400 flex items-center mt-2"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-4 w-4 mr-1"
    ...
    >
      <div class="flex justify-between items-start">
        <div>
          ...
          <h3 class="text-2xl font-bold text-gray-900 dark:text-white mt-1">
            {formatCurrency(customerAnalytics.averageEventValue)}
          </h3>
          <p
            class="text-sm text-green-600 dark:text-green-400 flex items-center mt-2"
          >
  ...
  >
    <div class="flex flex-col lg:flex-row gap-4">
      <div class="flex flex-col sm:flex-row gap-4 flex-grow">
        ...
        >
          <button
            class="px-4 py-2 text-sm font-medium flex items-center {selectedView ===
            'grid'
        ...
        >
          {#each getPaginatedCustomers() as customer}
            ...
            >
              <div class="p-5">
                <div class="flex items-start justify-between mb-3">
                  <div class="flex items-center">
                    <div
                      class="flex-shrink-0 h-12 w-12 rounded-full {getRandomColor(
                        customer.name,
              ...
              <div
                class="bg-gray-50 dark:bg-gray-900/30 px-5 py-3 border-t border-gray-100 dark:border-gray-700"
              >
                <div class="flex justify-between items-center">
                  <div class="text-sm text-gray-500 dark:text-gray-400">
                    <span class="font-medium text-gray-900 dark:text-white"
                      >{customer.events?.length || 0}</span
                    > boekingen
                  </div>
                  <div
              ...
              >
                {#each getPaginatedCustomers() as customer}
                  ...
                  >
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <span
                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {customer.type ===
                        'business'
                          ? 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300'
                          : 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300'}"
                      >
      ...
      {#if selectedCustomer}
        <div class="p-6">
          ...
          <div class="mt-6 flex flex-col sm:flex-row sm:items-center">
            ...
            <div class="mt-4 sm:mt-0 sm:ml-6">
              ...
              <div class="mt-1 flex items-center flex-wrap gap-2">
                <span
                  class="px-2.5 py-0.5 rounded-full text-xs font-medium {selectedCustomer.type ===
                  'business'
                    ? 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300'
                    : 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300'}"
                >
                ...
                {#if selectedCustomer.marketingConsent}
                  <span
                    class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300"
                  >
                    Marketing opt-in
                  </span>
                {/if}
          ...
          <div class="mt-6 flex flex-wrap gap-3">
            ...
            <button
              class="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mr-2"
          ...
          <div class="mt-8">
            ...
            <div class="mt-6 space-y-6">
              ...
              <div>
                ...
                <div
                  class="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4 space-y-3"
                >
                  ...
                  <div class="flex items-start">
                    ...
                    >
                      ...
                      <path
                        fill="currentColor"
                        d="M12 11.5a2.5 2.5 0 0 0 0-5a2.5 2.5 0 0 0 0 5z"
                      />
                    </svg>
                    <div>
                      <p
              ...
              <div>
                ...
                <div class="flex flex-wrap gap-2">
                  ...
                  {/each}
                  <button
                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border border-dashed border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-4 w-4 mr-1"
              ...
              <div>
                ...
                {#if !selectedCustomer.events || selectedCustomer.events.length === 0}
                  <div
                    class="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4 text-center"
                  >
              ...
              <div>
                ...
                <div class="bg-gray-50 dark:bg-gray-900/30 rounded-lg p-4">
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                    Laatste contact: {formatDate(selectedCustomer.lastContact)}
                  </p>
                </div>
              </div>
            </div>
      ...
      <form class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
              <label
                for="company-name"
                class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
                >Bedrijfsnaam (indien van toepassing)</label
              >
              <input
                type="text"
                id="company-name"
        ...
        <div>
          ...
          <div class="flex flex-wrap gap-2">
            ...
            {/each}
            <button
              class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium border border-dashed border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-4 w-4 mr-1"
...
{#if showEmailComposer}
  ...
  >
    ...
    >
      <div class="flex justify-between items-start mb-6">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white">
          E-mail naar {selectedCustomer?.name || ""}
        </h2>
        <button
          on:click={closeEmailComposer}
          class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
...
<button
  class="w-full mt-8 flex justify-between items-center text-left p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow"
>
  <h2 class="text-lg font-medium text-gray-900 dark:text-white">
    Klantanalyse en -inzichten
  </h2>
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
<div
  class="mt-4 space-y-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6"
>
      ...
      <div class="flex items-center justify-center">
        <div class="relative w-48 h-48">
          ...
          <div class="absolute inset-0 rounded-full overflow-hidden">
            ...
            <div
              class="absolute inset-0 origin-center rotate-[120deg] bg-purple-500 dark:bg-purple-400"
            ></div>
            <div
              class="absolute inset-0 origin-center rotate-[300deg] bg-yellow-500 dark:bg-yellow-400"
            ></div>
            <div
              class="absolute inset-0 rounded-full overflow-hidden flex items-center justify-center bg-white dark:bg-gray-800 scale-[0.7]"
            ></div>
          </div>
        </div>
      </div>
            ...
            <div class="flex-1">
              <div class="flex justify-between">
                ...
                <span class="text-sm text-gray-700 dark:text-gray-300"
                  >{item.count} klanten</span
                >
              </div>
              <div
                class="w-full h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full mt-1"
              >
                <div
      ...
      <div class="flex h-full items-end space-x-2">
        {#each customerAnalytics.customerGrowth as item}
          <div class="flex-1 flex flex-col items-center">
            <div
              class="w-full bg-blue-100 dark:bg-blue-900/30 rounded-t-sm relative"
              style="height: {(item.count /
                Math.max(
                  ...customerAnalytics.customerGrowth.map((i) => i.count),
                )) *
                100}%"
            >
              <div
                class="absolute inset-0 bg-blue-500 dark:bg-blue-400 opacity-30 rounded-t-sm"
              ></div>
              <div
                class="absolute bottom-0 left-0 right-0 bg-blue-500 dark:bg-blue-400 h-1"
              ></div>
              <div
                class="absolute -top-7 left-1/2 transform -translate-x-1/2 text-xs font-medium text-gray-700 dark:text-gray-300"
              >
                {item.count}
              </div>
            </div>
    ...
    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-5">
      ...
      <ul class="space-y-3">
        <li class="flex items-start">
          <div
            class="flex-shrink-0 h-5 w-5 rounded-full bg-blue-500 dark:bg-blue-400 flex items-center justify-center text-white dark:text-blue-900 text-xs font-bold"
          >
            !
          </div>
          <p class="ml-3 text-sm text-blue-800 dark:text-blue-200">
            3 klanten hebben binnenkort hun verjaardag. Stuur een felicitatie en
            kortingsbon.
          </p>
        </li>
        <li class="flex items-start">
          ...
          <p class="ml-3 text-sm text-blue-800 dark:text-blue-200">
            5 klanten hebben meer dan 6 maanden geen boeking geplaatst. Overweeg
            een heractivatie campagne.
          </p>
        </li>
        <li class="flex items-start">
          <div
          ...
          <p class="ml-3 text-sm text-blue-800 dark:text-blue-200">
            Bedrijfsklanten geven gemiddeld 35% meer uit dan particulieren.
            Focus op het aantrekken van meer zakelijke evenementen.
          </p>
        </li>
      </ul>
    </div>
