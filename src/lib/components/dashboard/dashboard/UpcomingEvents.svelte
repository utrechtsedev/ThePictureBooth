...
>
  <div
    class="flex justify-between items-center px-5 py-4 border-b border-gray-100 dark:border-gray-700"
  >
    ...
    {#if upcomingEvents.length === 0}
      <div class="p-5 text-center">
        <p class="text-gray-500 dark:text-gray-400">
          Geen nieuwe aankomende evenementen
        </p>
      </div>
    {/if}
    {#each upcomingEvents as event}
      <div
        class="p-5 hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-colors"
      >
        <div class="flex justify-between">
          ...
          <div class="flex flex-col items-end">
            <span
              class="px-2.5 py-0.5 rounded-full text-xs font-medium mb-2 {getStatusClass(
                event.status,
              )}"
            >
