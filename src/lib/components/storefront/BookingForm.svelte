...
>
  <!-- Form Title -->
  <h2
    class="crazyfont text-4xl text-center mb-3 bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text text-transparent"
  >
    <p class="inline-flex text-white">📸</p>
    Direct Boeken
  </h2>
  ...
  {#if formSubmitted}
    <div
      class="animate-fade-in-up mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg"
      role="alert"
    >
      <div class="flex items-start gap-3 text-yellow-600">
        <svg
          class="flex-shrink-0 w-5 h-5 mt-1"
          fill="currentColor"
          viewBox="0 0 20 20"
  ...
  <div class="space-y-6">
        ...
        <div class="animate-fade-in-up" style="--delay: 0.1s">
          ...
          <input
            ...
            class="w-full px-4 py-3 rounded-lg bg-white border border-gray-300 text-gray-800 placeholder-gray-400
                    focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500/30 transition-all"
          ...
          <div class="relative">
            <select
              ...
              class="appearance-none w-full px-4 py-3 rounded-lg bg-white border border-gray-300 text-gray-800
                        focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500/30 transition-all"
            >
              <option value="3u">3 uur - €250</option>
              <option value="4u">4 uur - €300</option>
              <option value="5u">5 uur - €350</option>
              <option value="6u">6 uur - €400</option>
            </select>
            <svg
              class="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 pointer-events-none"
              fill="currentColor"
    ...
    <!-- Order Summary -->
    <div
      class="animate-fade-in-up bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-xl p-5 border border-yellow-100 shadow-sm"
    >
      ...
      <div class="grid grid-cols-2 gap-3 mb-4">
        ...
        <div class="text-gray-800 font-medium">
          {durationPrices[selectedDuration].label} ({selectedDuration[0]} uur)
        </div>
      ...
      <div class="grid grid-cols-2 gap-3 pt-3 border-t border-yellow-100">
    ...
    >
      <input
        id="terms"
        type="checkbox"
        class="mt-1 w-5 h-5 rounded-md bg-white focus:ring--500/50 checked:bg-yellow-500"
        w
        required
        bind:checked={terms}
      />
      <label for="terms" class="text-gray-600 text-sm">
        ...
        <a
          href="/voorwaarden"
          class="text-yellow-600 hover:text-yellow-500 transition-colors underline underline-offset-2"
        >
          voorwaarden
        </a>
    ...
    <button
      type="submit"
      class="animate-fade-in-up w-full crazyfont py-4 px-8 rounded-xl bg-gradient-to-r from-yellow-500 to-yellow-500
              text-white text-xl font-semibold shadow-lg hover:shadow-xl hover:from-yellow-400 hover:to-yellow-400
